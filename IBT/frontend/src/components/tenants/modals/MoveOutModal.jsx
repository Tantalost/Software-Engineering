             ...
             <div className="flex flex-col gap-3">
                <div className="flex flex-col gap-1">
                  ...
                  <div className="relative">
                     ...
                     <input type="number" min="0" placeholder="0.00" value={damageCost} onChange={(e) => setDamageCost(e.target.value)} className="pl-8 p-2.5 w-full rounded-lg border border-slate-300 focus:ring-2 focus:ring-red-500 outline-none" />
                  </div>
                </div>
                <div className="flex flex-col gap-1">
                  <label className="text-xs font-semibold text-slate-500">Damage Remarks (Optional)</label>
                  <input type="text" placeholder="e.g., Broken lights, uncleaned grease..." value={damageRemarks} onChange={(e) => setDamageRemarks(e.target.value)} className="p-2.5 w-full rounded-lg border border-slate-300 focus:ring-2 focus:ring-red-500 outline-none" />
                </div>
             </div>
          </div>
          ...
          <div className="bg-emerald-50 p-4 rounded-xl border border-emerald-100">
            ...
            <div className="flex flex-col gap-2 text-sm">
                ...
                <div className="border-t border-emerald-200 my-1 pt-2 flex justify-between items-center">
                    ...
                    <span className={`text-lg font-black ${refund < 0 ? 'text-red-600' : 'text-emerald-700'}`}>

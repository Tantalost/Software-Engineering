          ...
          <div className="flex justify-end items-center space-x-2">
            ...
            <button
              onClick={(e) => {
                ...
                setArchiveRow(originalRecord ? { ...originalRecord, ticket: row.ticket } : row);
              }}
              title="Archive"
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="mt-2 text-sm text-slate-700">
                ...
                <span className="font-semibold">
                  Ticket #{archiveRow.ticket || `#${String(archiveRow.ticketNo || '').padStart(4, '0')}`}
                </span>{" "}
                to the Archives?
              </p>

              <p className="mt-1 text-xs font-medium text-red-500">
                This item will be permanently removed from the active parking
                list.
              </p>

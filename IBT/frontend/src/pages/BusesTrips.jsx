        ...
        <div className="flex flex-col gap-4 w-full mb-4">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
              ...
              <div className="flex flex-wrap items-center justify-end gap-3 w-full lg:w-auto">
                 {role === "superadmin" && (
                  <>
                    <button onClick={() => { setNewPrice(defaultPrice.toString()); setShowSetPriceModal(true); }} className="flex items-center cursor-pointer justify-center space-x-2 border border-slate-200 bg-white text-slate-700 font-semibold px-4 py-2.5 rounded-xl shadow-sm hover:bg-slate-50 transition-all">
                      <Settings size={18} /> <span className="hidden sm:inline">Set Price</span>
                    </button>
                    <button onClick={() => setShowManageCompaniesModal(true)} className="flex items-center cursor-pointer justify-center space-x-2 border border-slate-200 bg-white text-slate-700 font-semibold px-4 py-2.5 rounded-xl shadow-sm hover:bg-slate-50 transition-all">
                      <Bus size={18} /> <span className="hidden sm:inline">Manage Companies</span>
                    </button>
                  </>
                )}
          ...
          <div className="flex flex-col xl:flex-row xl:items-start justify-end gap-4">
            {role === "superadmin" && (
            ...
            <div className={`flex flex-wrap items-center justify-end gap-3 ${isSelectionMode ? "ml-auto" : "w-full"}`}>
              {role === "bus" && (
                <div className="mr-auto flex flex-wrap items-center gap-2">
                  ...
                  >
                    <span className="hidden sm:inline">View Missed Buses</span>
                  </button>
                  <button
                    onClick={() => {

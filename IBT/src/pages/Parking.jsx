...
export default function IBTSlotManagement() {
  ...
  const [selectedMenuItem, setSelectedMenuItem] = useState('Parking');

  const slots = [
    { ticketNo: 1, vehicleType: 'Car', price: '30.00' },
    { ticketNo: 2, vehicleType: 'Car', price: '30.00' },
    { ticketNo: 3, vehicleType: 'Car', price: '30.00' },
    { ticketNo: 4, vehicleType: 'Motorcycle', price: '10.00' },
    { ticketNo: 5, vehicleType: 'Motorcycle', price: '10.00' },
    { ticketNo: 6, vehicleType: 'Motorcycle', price: '10.00' },
    { ticketNo: 7, vehicleType: 'Motorcycle', price: '10.00' },
    { ticketNo: 8, vehicleType: 'Motorcycle', price: '15.00' },
    { ticketNo: 9, vehicleType: 'Car', price: '30.00' },
    { ticketNo: 10, vehicleType: 'Car', price: '30.00' }
  ];
  ...
  const filteredSlots = slots.filter(slot =>
    ...
    slot.vehicleType.toLowerCase().includes(searchQuery.toLowerCase())
  );

  const motorcycles = slots.filter(s => s.vehicleType === 'Motorcycle').length;
  const cars = slots.filter(s => s.vehicleType === 'Car').length;
  const totalVehicles = slots.length;
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-white rounded-lg border border-gray-200 p-4">
              <div className="flex items-start justify-between">
                <div>
                  <div className="text-sm text-gray-600 mb-1">Motorcycles</div>
                  <div className="text-4xl font-bold text-gray-900">{motorcycles}</div>
                  <div className="mt-2">
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-4">
              <div className="flex items-start justify-between">
                <div>
                  <div className="text-sm text-gray-600 mb-1">Cars</div>
                  <div className="text-4xl font-bold text-gray-900">{cars}</div>
                  <div className="mt-2">
                    <span className="text-sm text-gray-600">Today</span>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-4">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <div className="text-4xl font-bold text-gray-900">{totalVehicles}</div>
                  <div className="mt-2">
                    <span className="text-sm text-gray-600">Today</span>
                  </div>
                </div>
              ...
              <div key={slot.ticketNo} className="bg-white rounded-lg shadow p-4 space-y-3">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="text-gray-900 font-medium">{slot.vehicleType}</span>
                  </div>
                </div>
              </div>
            ))}

...
const NotFound = () => {
    ...
    return (
        <div class="mt-50 flex flex-col items-center justify-center text-sm max-md:px-4">
            ...
            <div class="flex items-center gap-4 mt-6">
                <a href="/dashboard" class="bg-gray-800 hover:bg-black px-7 py-2.5 text-white rounded-md active:scale-95 transition-all">
                    Return Home
                </a>
